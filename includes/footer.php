    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <p class="footer-desc">
                    SRDK Biochemicals specializes in the design and production of high-purity, FDA-relevant
                    bioabsorbable polymers. We are dedicated to innovating polymers for better therapeutic outcomes.
                </p>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                ...
                <ul class="footer-contact-info">
                    <li>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" width="20" height="20" class="contact-icon">
