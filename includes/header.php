...
<head>
    ...
    <meta name="description" content="SRDK Biochemicals - Innovating Polymers for Better Therapies. Pharmaceutical-grade bioabsorbable polymers for drug delivery, 3D bioprinting, and biomedical applications.">
    <meta name="keywords" content="SRDK Biochemicals, polymers, PLGA, PEG-PLGA, PEGDA, PEGDMA, bioabsorbable polymers, drug delivery, 3D bioprinting, pharmaceutical">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Montserrat:wght@400;500;600;700;800&family=Open+Sans:wght@300;400;600;700&display=swap" rel="stylesheet">
        ...
        <div class="header-inner">
            ...
            <ul class="header-nav" id="header-nav">
                ...
                <li class="nav-item has-dropdown">
                    <a href="#services" class="nav-link">Services <i class="bi bi-chevron-down"></i></a>
                    <ul class="sub-menu">
                        <li><a href="#drug-delivery" class="sub-menu-link">Drug Delivery Polymers</a></li>
                        <li><a href="#3d-bioprinting" class="sub-menu-link">3D Bioprinting Polymers</a></li>
                        <li><a href="#specialty" class="sub-menu-link">Specialty Polymers</a></li>
                        <li><a href="#applications" class="sub-menu-link">Applications & Partnerships</a></li>
                    </ul>
                </li>
                <li class="nav-item has-dropdown">
